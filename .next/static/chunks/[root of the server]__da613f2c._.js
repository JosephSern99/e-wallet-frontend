(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__da613f2c._.js", {
...
const WalletProvider = ({ children })=>{
    ...
    const fetchWallet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WalletProvider.useCallback[fetchWallet]": async ()=>{
            ...
            try {
                setLoading(true);
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].getWallet();
    ...
    const fetchTransactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WalletProvider.useCallback[fetchTransactions]": async (params)=>{
            ...
            try {
                setLoading(true);
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].getTransactions(params);
    ...
    const deposit = async (amount)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].deposit(amount);
            await fetchWallet();
            return response.data;
        } catch (err) {
            throw err;
    ...
    const withdraw = async (amount)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].withdraw(amount);
            await fetchWallet();
            return response.data;
        } catch (err) {
            throw err;
    ...
    const transfer = async (recipientWalletNumber, amount, description)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].transfer(recipientWalletNumber, amount, description);
            await fetchWallet();
            return response.data;
        } catch (err) {
            throw err;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__da613f2c._.js.map