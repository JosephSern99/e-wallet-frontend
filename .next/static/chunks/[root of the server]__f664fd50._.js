(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__f664fd50._.js", {
...
const AuthProvider = ({ children })=>{
    ...
    const login = async (credentials)=>{
        try {
            ...
            const userProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].getCurrentUser();
            setUser(userProfile);
...
const AuthProvider = ({ children })=>{
    ...
    const login = async (credentials)=>{
        try {
            ...
            localStorage.setItem('token', token);
            // Fetch the user profile after storing the token
            const userProfile = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$service$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].getCurrentUser();
            setUser(userProfile);
            router.push('/dashboard'); // Use router.push to redirect to the dashboard
            return {
                success: true,
...
const WalletService = {
    getWallet: async ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get('/wallet');
    },
    getTransactions: async (params)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get('/wallet/transactions', {
            params
        });
    },
    deposit: async (amount)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post('/wallet/deposit', {
            amount
        });
    },
    withdraw: async (amount)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post('/wallet/withdraw', {
            amount
        });
    },
    transfer: async (recipientWalletNumber, amount, description)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post('/wallet/transfer', {
    ...
    getTransaction: async (transactionId)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`/wallet/transactions/${transactionId}`);
    }
};
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f664fd50._.js.map