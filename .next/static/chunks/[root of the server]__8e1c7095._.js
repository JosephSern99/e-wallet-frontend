(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__8e1c7095._.js", {
...
const WalletProvider = ({ children })=>{
    ...
    const fetchTransactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WalletProvider.useCallback[fetchTransactions]": async (params)=>{
            if (!user) return;
            try {
                setLoading(true);
...
const useWallet = ()=>{
    ...
    const wallet = undefined, setWallet = undefined;
    const transactions = undefined, setTransactions = undefined;
    const loading = undefined, setLoading = undefined;
    const error = undefined, setError = undefined;
    const fetchWallet = undefined;
    const fetchTransactions = undefined;
    const deposit = undefined;
    const withdraw = undefined;
    const transfer = undefined;
};
_s(useWallet, "mvJJdOalxce4GoCarcQX3YVaF4A=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8e1c7095._.js.map