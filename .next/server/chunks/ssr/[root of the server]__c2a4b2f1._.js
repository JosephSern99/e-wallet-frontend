...
const WalletProvider = ({ children })=>{
    ...
    const withdraw = async (walletId, amount, description, type, categoryid)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$service$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].withdraw(walletId, amount, description, type, categoryid);
            await fetchWallet();
            return response.data;
        } catch (err) {
            throw err;
    ...
    const transfer = async (recipientWalletNumber, amount, description, type, categoryid, walletId)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$service$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].transfer(recipientWalletNumber, amount, description, type, categoryid, walletId);
            await fetchWallet();
            return response.data;
        } catch (err) {
            throw err;
...
"[project]/src/pages/wallet/index.js [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const Wallet = ()=>{
    const { wallet, loading: walletLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useWallet$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["useWallet"])();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c2a4b2f1._.js.map